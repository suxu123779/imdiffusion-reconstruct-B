...
DEFAULT_SCORE_NAMES = [
    "hidden_path_top3_late_mean_zabs",
    "hidden_path_top3_mean_zabs",
    "hidden_path_top3_late_mean_zpos",
    "hidden_path_top3_mean_zpos",
]
...
def main():
    ...
    parser.add_argument("--out", type=str, default="pathB_hidden_path_auc_summary.csv")
    ...
    print(f"saved hidden path AUC summary to {args.out}")
    print(f"saved hidden path per-save AUC summary to {per_save_out}")
